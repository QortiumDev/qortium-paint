...
describe('copyTextToClipboard', () => {
  it('uses navigator.clipboard when the QDN view permits it', async () => {
    ...
    await expect(copyTextToClipboard('qdn://APP/Node/Node?view=developers', dependencies)).resolves.toBe(true);
    expect(writeText).toHaveBeenCalledWith('qdn://APP/Node/Node?view=developers');
  });
